  ...
  <header>
        ...
        >
          <div>
            <div class="mp:w-full mp:bg-white mp:relative mp:m-0 tab:ml-px">
              ...
              <div
                class="hidden mp:flex mp:absolute mp:top-[2px] mp:right-[0px] mp:h-[36px] mp:w-[40px] mp:bg-[#fff] mp:border-l-0 mp:justify-center mp:items-center"
              >
                <span>
                  <HeaderSearch />
                </span>
    ...
    <nav class="">
      <button
        ...
        class="cursor-pointer border-0 inline-flex bg-transparent outline-0 m-0 mp:relative mp:z-[10]"
      >
        <label
