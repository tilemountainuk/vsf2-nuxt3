<template>
  <div class="flex flex-wrap gap-4 lg:gap-6 lg:flex-nowrap my-16">
    <div
      v-for="({ icon, title, description, buttonText, isDisabled }, index) in cardDetails"
      :key="`${title}-${index}`"
      class="flex flex-col w-full max-w-[325px] sm:w-[375px] lg:w-[496px] bg-[#F6F6F6] items-start"
    >
...
import { TMIconsForum } from '#components';
