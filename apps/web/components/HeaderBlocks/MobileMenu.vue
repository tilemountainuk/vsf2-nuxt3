<template>
  <div>
    ...
    >
      <nav>
        <!-- <div class="md:hidden fixed inset-0 bg-neutral-500 bg-opacity-50"></div> -->
        <ul>
...
import { SfButton, SfListItem, useDisclosure, SfIconClose } from '@storefront-ui/vue';
