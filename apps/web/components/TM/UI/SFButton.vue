...
<template>
  <component
      ...
      :disabled="disabled"
      :class="[
      'inline-flex items-center justify-center font-medium text-base rounded-md focus-visible:outline focus-visible:outline-offset disabled:text-disabled-500 disabled:bg-disabled-300 disabled:shadow-none disabled:ring-0 disabled:cursor-not-allowed',
      sizeClasses,
