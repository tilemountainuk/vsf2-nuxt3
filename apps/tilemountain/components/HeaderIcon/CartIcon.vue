<template>
  <svg
    ...
    class="h-[29px] 1xl:w-[29px] 1tab:h-[25px] 1tab:-mt-[4px] tab:h-[19px] tab:-mt-[2px] ph:h-full ph:w-[30px] ph:w-[30px] ph:m-0 ph:-mt-10 ph:-min-h-[83px] 4xs:w-[25px]"
    xml:space="preserve"
  >
    <g transform="translate(0.000000,109.000000) scale(0.100000,-0.100000)">
      <path
        class="st2"
        fill="#29275b"
        d="M3401.1-260.4c-571.1-571.1-650.7-664.5-633.4-737.2c20.8-72.7,145.4-166.1,221.5-166.1
        c13.8,0,315,290.7,674.9,647.2c668,664.5,716.5,737.2,595.3,854.9C4141.8,459.5,4069.1,407.6,3401.1-260.4z"
      />
      <path
        class="st2"
        fill="#29275b"
        d="M47.2-841.9C33.4-852.2,23-1032.2,23-1236.4c0-335.7,6.9-377.3,65.8-411.9c38.1-17.3,103.8-34.6,148.8-34.6
