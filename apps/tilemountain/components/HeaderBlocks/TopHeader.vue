<template>
  <div class="container mp:max-w-full 2xl:max-w-7xl mx-auto flex relative">
    <div
      class="between-xs relative z-10 bg-white middle-xs flex flex-initial flex-row flex-wrap -mr-2 justify-between items-center ml-2 tab:-ml-[6px] mp:m-0"
    >
      <div class="md:max-w-[16.66666667%] basis-2/6 max-w-[33.33333333%]">
        <div class="mp:pl-5 small:pt:0 4xs:pt-0">
          <NuxtLink to="/" title="Home Page" class="inline-flex">
      ...
      >
        <div>
          <div class="mp:w-full mp:bg-white mp:relative mp:m-0 tab:ml-px">
            <div class="relative mr-0 mp:mt-1 1tab:mt-1">
              <div
                class="px15 ml-auto mr-auto pr-2 pl-2 mp:pr-0 mp:pl-0"
              >
                <div class="flex flex-initial flex-row flex-wrap -mr-2 -ml-2">
                  <div
                  ...
                  >
                    <div class="search-input-group relative border-0 justify-end flex mp:m-0 mp:w-full">
                      ...
                      <form class="w-full relative mp:flex">
                        <input
                          autocomplete="off"
                          placeholder="Search..."
                          value=""
            ...
            <div
              class="hidden mp:flex mp:absolute mp:top-[2px] mp:right-[0px] mp:h-[36px] mp:w-[40px] mp:bg-transparent border-[#bdbdbd] mp:border-l-2 mp:justify-center mp:items-center"
            >
      ...
      >
        <div class="flex mr-8">
          <NuxtLink to="/i/contact-us" class="flex items-center">
            <HeaderIconPhoneIcon class="w-7" />
            <span class="text-lg font-bold text-[#29275b]">Need help?</span>
          </NuxtLink>
        </div>
        <div class="flex">
          <NuxtLink to="/i/contact-us" class="flex flex-col items-center">
            <HeaderIconShowroomIcon class="w-6" />
            <span class="text-[13.33px] font-bold text-[#29275b]">Showrooms</span>
          </NuxtLink>
        </div>
        <div class="flex self-start">
          <NuxtLink to="/i/contact-us" class="flex">
            <HeaderIconAccountIcon class="w-6" />
            <span class="hidden">Name</span>
          </NuxtLink>
        </div>
        <div class="flex">
          <NuxtLink to="/i/contact-us" class="flex items-baseline">
            <div class="relative mr-4">
              <span class="flex items-center justify-center text-xs rounded-[50%] bg-[#ed108c] text-white w-[18px] h-[18px] absolute -right-1 -top-1">
                0
              </span>
              <HeaderIconCartIcon class="w-7" />
            </div>
            <span class="text-[17px] font-bold text-[#29275b]">£1,230.29</span>
          </NuxtLink>
        </div>
