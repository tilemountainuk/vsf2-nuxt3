...
import CategoryCard from '@base/components/ui/CategoryCard/CategoryCard.vue';
import Display from '@base/components/ui/Display/Display.vue';
import Hero from '@base/components/ui/Hero/Hero.vue';
